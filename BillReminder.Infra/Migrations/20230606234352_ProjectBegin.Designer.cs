...
namespace BillReminder.Infra.Migrations
{
    ...
    [Migration("20230606234352_ProjectBegin")]
    partial class ProjectBegin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BillReminder.Domain.Entities.Reminder", b =>
                {
                    b.HasOne("BillReminder.Domain.Entities.Bill", "Bill")
                        .WithOne("Reminder")
                        .HasForeignKey("BillReminder.Domain.Entities.Reminder", "BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Reminder_Bill");
